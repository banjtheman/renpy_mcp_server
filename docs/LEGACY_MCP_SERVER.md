# Legacy Ren'Py MCP server

> For new games, use the [Ren'Py skill](../README.md). This guide preserves the Python MCP server setup and usage for existing integrations. Its demos and image-provider requirements describe that workflow.
